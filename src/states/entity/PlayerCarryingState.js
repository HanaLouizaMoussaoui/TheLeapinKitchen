...
export default class PlayerCarryingState extends State {
	...
	constructor(player) {
		...
		this.player = player;
		this.animation = {
			[Direction.Up]: new Animation([20, 21], 0.1),
			[Direction.Down]: new Animation([12, 13], 0.1),
			[Direction.Left]: new Animation([16, 17], 0.1),
			[Direction.Right]: new Animation([16, 17], 0.1),
		};
	}
